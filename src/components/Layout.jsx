...
import { Logo } from '@/components/Geez'
...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        title: 'Does not provide attribute',
        href: '/docs/Does not provide attribute'
      }],
  },
]
  ...
  return (
    ...
    >
      ...
      <div className="relative flex justify-end gap-6 basis-0 sm:gap-8 md:flex-grow">
        ...
        <Link href="https://github.com/kkinfe" className="group" aria-label="GitHub">
